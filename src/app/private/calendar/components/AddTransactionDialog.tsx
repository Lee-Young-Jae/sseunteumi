...
import { useCreateTransaction } from "@/queries/useTransactionQuery";
...
const transactionFormSchema = z.object({
  ...
  categories_id: z.string().optional(),
  ...
  const onSubmit = async (data: TransactionFormData) => {
    try {
      createTransaction({
        ...
        categories_id: type === "expense" ? data.categories_id : undefined,
        transaction_date: new Date(selectedDate),
        type,
      });
      onOpenChange(false);
      reset();
